...
namespace OCC.WpfClient.Features.SplashHub
{
    public class SplashFeature : IFeature
    {
        ...
        public void RegisterRoutes(INavigationService navigationService)
        {
            ...
            navigationService.RegisterRoute(NavigationRoutes.Home, typeof(OCC.WpfClient.Features.MainHub.ViewModels.DashboardViewModel));
        }
