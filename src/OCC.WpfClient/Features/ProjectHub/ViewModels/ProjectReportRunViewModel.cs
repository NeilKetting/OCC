            ...
            try
            {
                ...
                else
                {
                    ...
                    if (roots.Count == 1)
                    {
                        ...
                        if (ProjectDetails != null && !string.IsNullOrEmpty(ProjectDetails.Name))
                        {
                            nameMatchesProject = root.Name.Contains(ProjectDetails.Name, StringComparison.OrdinalIgnoreCase) ||
                                                 ProjectDetails.Name.Contains(root.Name, StringComparison.OrdinalIgnoreCase);
                        }
