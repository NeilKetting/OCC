...
namespace OCC.WpfClient.Services.Interfaces
{
    public interface IPdfService
    {
        ...
        /// </summary>
        Task<string> GenerateWageRunPdfAsync(WageRun wageRun, bool hideAfterComments = false, bool hideDecColumns = false, Dictionary<string, bool>? visibleColumns = null, bool excludeZeroWages = false);
